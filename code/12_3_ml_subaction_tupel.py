...
dataframe = dataframe.drop(['nummer1','nummer2','action_length2','action2','origin_action2','request2_1','request2_2','request2_3','request2_4','request2_5','request2_6','response2'], axis=1)
...
def dataframe_to_dataset(dataframe):
    ...
    labels = dataframe.pop("subaction2")
...
keras.utils.plot_model(model, show_shapes=True, rankdir="LR", to_file='C:/thesis-goettert/numpyarray/plotmodelsubaction_tupel.png')
