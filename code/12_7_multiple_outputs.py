...
val_dataframe.to_csv('C:/thesis-goettert/numpyarray/multiple_outputs_predictions_data.csv', sep='\t', encoding='utf-8')
...
output1 = keras.layers.Dense(29, activation="sigmoid", name='action2')(x)
output2 = keras.layers.Dense(58, activation="sigmoid", name='subaction2')(x)
output3 = keras.layers.Dense(1, activation="linear", name='action_length2')(x)
output4 = keras.layers.Dense(29, activation="sigmoid", name='origin_action2')(x)
output5 = keras.layers.Dense(5, activation="sigmoid", name='request2_1')(x)
output6 = keras.layers.Dense(1, name='request2_2')(x)
output7 = keras.layers.Dense(2, activation="sigmoid", name='request2_3')(x)
output8 = keras.layers.Dense(2, activation="sigmoid", name='request2_4')(x)
output9 = keras.layers.Dense(1, name='request2_5')(x)
output10 = keras.layers.Dense(3, activation="sigmoid", name='request2_6')(x)
output11 = keras.layers.Dense(1, name='response2')(x)
...
encoder.fit(train_ds, epochs=10, verbose=2, validation_data=val_ds) 

encoder.save('C:/thesis-goettert/saved_model')

score = encoder.predict(pred_ds,verbose=2)  
...
prediction_df.to_csv('C:/thesis-goettert/numpyarray/2nd_step.csv',header= namelist, index = False, sep='\t', encoding='utf-8')
