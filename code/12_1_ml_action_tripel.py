...
dataframe = dataframe.drop(['nummer1','nummer2','nummer3','action_length3','subaction3','origin_action3','request3_1','request3_2','request3_3','request3_4','request3_5','request3_6','response3'], axis=1)
...
request2_4_encoded = encode_categorical_feature(request2_4, "request2_4", train_ds, False)
request2_6_encoded = encode_categorical_feature(request2_6, "request2_6", train_ds, False)
...
keras.utils.plot_model(model, show_shapes=True, rankdir="LR", to_file='C:/thesis-goettert/numpyarray/plotmodel2.png')
